const articles = {
  ...
  queryGetAllArticles: `SELECT * FROM articles WHERE (published=$1 AND hidden=false AND $2 = '' OR title ILIKE $2) OFFSET $3 LIMIT $4`,
  ...
  queryDeleteArticle: `UPDATE articles SET hidden=true WHERE article_id=$1`,
};
const topics = {
